...
if(isset($_GET['title']) && strlen($_GET['title'])>0){
	...
	$query="INSERT INTO movies(id,title,notes,rating,priority,watched)  VALUES (NULL, '$title', '$notes', NULL, '$priority', '$watched')";//(NULL, $title, $notes, $rating, $priority, $watched)";
